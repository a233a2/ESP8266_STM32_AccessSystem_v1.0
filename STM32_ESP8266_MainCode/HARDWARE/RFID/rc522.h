...
#define          RC522_Reset_Enable()      GPIO_ResetBits( GPIOC, GPIO_Pin_2 )
#define          RC522_Reset_Disable()     GPIO_SetBits ( GPIOC, GPIO_Pin_2 )

#define          RC522_SCK_0()             GPIO_ResetBits( GPIOA, GPIO_Pin_2 )
#define          RC522_SCK_1()             GPIO_SetBits ( GPIOA, GPIO_Pin_2 )

#define          RC522_MOSI_0()            GPIO_ResetBits( GPIOA, GPIO_Pin_0 )
#define          RC522_MOSI_1()            GPIO_SetBits ( GPIOA, GPIO_Pin_0 )
...
void 						 RC522_MOVE_CARD            (void);													//记录和读取函数程序
void 					  	DOOR_OPEN										(void); 
void 					  	WIFI_OPEN_DOOR							(void);
void 						 RC522_READ_CARD            (void);													//记录和读取函数程序
void 						 RC522_OPEN_DOOR            (void);													//开门沉痼哦
